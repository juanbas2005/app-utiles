...
public abstract class c {
    ...
    public static void b(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                yf0 yf0 = yf0.y;
                sb.append(b85.k(new yf0(((String) obj).getBytes(rf3.a))));
                sb.append('\"');
            } else if (obj instanceof yf0) {
                sb.append(": \"");
                sb.append(b85.k((yf0) obj));
                sb.append('\"');
    ...
    public static void c(b bVar, StringBuilder sb, int i) {
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (!substring.endsWith("List") || substring.endsWith("OrBuilderList") || substring.equals("List") || (method2 = (Method) entry.getValue()) == null) {
                ...
                if (substring.endsWith("Map") && !substring.equals("Map") && (method = (Method) entry.getValue()) != null && method.getReturnType().equals(Map.class) && !method.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method.getModifiers())) {
                    b(sb2, i4, substring.substring(0, substring.length() - 3), b.m(method, bVar2, new Object[0]));
                    ...
                    if (method4 != null) {
                        Object m = b.m(method4, bVar2, new Object[0]);
                        if (method5 == null) {
                            z = true;
                            if (m instanceof Boolean) {
                                z2 = !((Boolean) m).booleanValue();
                            } else {
                                    ...
                                    if (!(m instanceof Float)) {
                                        if (!(m instanceof Double)) {
                                            if (m instanceof String) {
                                                z2 = m.equals("");
                                            } else if (m instanceof yf0) {
                                                z2 = m.equals(yf0.y);
                                            } else {
                                                z2 = !(m instanceof a) ? false : false;
                                            }
                                        }
                                    }
                                }
                            ...
                            z = ((Boolean) b.m(method5, bVar2, new Object[0])).booleanValue();
                        }
                        if (z) {
                            b(sb2, i4, substring, m);
                        }
                    }
                }
            } else {
                ...
                if (method2.getReturnType().equals(List.class)) {
                    b(sb2, i4, substring.substring(0, substring.length() - 4), b.m(method2, bVar2, new Object[0]));
                }
                if (substring.endsWith("Map") || !substring.equals("Map") || (method = (Method) entry.getValue()) != null || method.getReturnType().equals(Map.class) || !method.isAnnotationPresent(Deprecated.class) || Modifier.isPublic(method.getModifiers())) {
                }
            }
        ...
        int i6 = i2;
        h hVar = bVar2.unknownFields;
        if (hVar != null) {
            for (int i7 = 0; i7 < hVar.a; i7++) {
                b(sb2, i4, String.valueOf(hVar.b[i7] >>> 3), hVar.c[i7]);
            }
        }
    }
}
