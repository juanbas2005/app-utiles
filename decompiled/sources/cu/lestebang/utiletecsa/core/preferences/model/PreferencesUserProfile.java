...
public final class PreferencesUserProfile {
    ...
    public /* synthetic */ PreferencesUserProfile(int i, String str, String str2, String str3, rl6 rl6) {
    ...
    public static final /* synthetic */ void write$Self$preferences(PreferencesUserProfile preferencesUserProfile, hy0 hy0, ll6 ll6) {
        if (hy0.f(ll6) || !sg3.e(preferencesUserProfile.id, new String())) {
            hy0.x(ll6, 0, preferencesUserProfile.id);
        }
        if (hy0.f(ll6) || !sg3.e(preferencesUserProfile.userName, new String())) {
            hy0.x(ll6, 1, preferencesUserProfile.userName);
        }
        if (hy0.f(ll6) || preferencesUserProfile.profilePictureUriString != null) {
            hy0.A(ll6, 2, t47.a, preferencesUserProfile.profilePictureUriString);
        }
    }
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0013\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lcu/lestebang/utiletecsa/core/preferences/model/PreferencesUserProfile$Companion;", "", "<init>", "()V", "Lzr3;", "Lcu/lestebang/utiletecsa/core/preferences/model/PreferencesUserProfile;", "serializer", "()Lzr3;", "preferences"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* compiled from: r8-map-id-a2600502e373284585f18be1dd969014ce4136ee711daf2a2a8e9cf573c31dbd */
    ...
    public /* synthetic */ PreferencesUserProfile(String str, String str2, String str3, int i, hl1 hl1) {
