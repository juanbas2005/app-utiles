...
public final class LicensePricingDto {
    ...
    public /* synthetic */ LicensePricingDto(int i, int i2, int i3, int i4, String str, String str2, rl6 rl6) {
    ...
    public static /* synthetic */ LicensePricingDto copy$default(LicensePricingDto licensePricingDto, int i, int i2, int i3, String str, String str2, int i4, Object obj) {
        ...
        String str3 = str;
        String str4 = str2;
        return licensePricingDto.copy(i, i2, i3, str3, str4);
    }

    public static final /* synthetic */ void write$Self$data(LicensePricingDto licensePricingDto, hy0 hy0, ll6 ll6) {
        if (hy0.f(ll6) || licensePricingDto.transferAmount != 200) {
            hy0.w(0, licensePricingDto.transferAmount, ll6);
        }
        if (hy0.f(ll6) || licensePricingDto.saldoAmount != 100) {
            hy0.w(1, licensePricingDto.saldoAmount, ll6);
        }
        if (hy0.f(ll6) || licensePricingDto.discountPercent != 0) {
            hy0.w(2, licensePricingDto.discountPercent, ll6);
        }
        if (hy0.f(ll6) || !sg3.e(licensePricingDto.discountSource, "NONE")) {
            hy0.x(ll6, 3, licensePricingDto.discountSource);
        }
        if (hy0.f(ll6) || !sg3.e(licensePricingDto.couponCode, "")) {
            hy0.x(ll6, 4, licensePricingDto.couponCode);
        }
    }
    ...
    public /* synthetic */ LicensePricingDto(int i, int i2, int i3, String str, String str2, int i4, hl1 hl1) {
        this(i, i2, (i4 & 4) != 0 ? 0 : i3, (i4 & 8) != 0 ? "NONE" : str, (i4 & 16) != 0 ? "" : str2);
        i = (i4 & 1) != 0 ? 200 : i;
        i2 = (i4 & 2) != 0 ? 100 : i2;
    }
}
