...
public final class AppReportDto {
    ...
    public /* synthetic */ AppReportDto(int i, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, rl6 rl6Var) {
        if (3 == (i & 3)) {
            this.type = str;
            this.message = str2;
            if ((i & 4) == 0) {
    ...
    public static /* synthetic */ AppReportDto copy$default(AppReportDto appReportDto, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, int i, Object obj) {
        ...
        String str11 = str5;
        String str12 = str6;
        return appReportDto.copy(str, str2, str3, str4, str11, str12, str9, str10);
    }

    public static final /* synthetic */ void write$Self$data(AppReportDto appReportDto, hy0 hy0Var, ll6 ll6Var) {
        hy0Var.x(ll6Var, 0, appReportDto.type);
        hy0Var.x(ll6Var, 1, appReportDto.message);
        if (hy0Var.f(ll6Var) || appReportDto.error != null) {
            hy0Var.A(ll6Var, 2, t47.a, appReportDto.error);
        }
        if (hy0Var.f(ll6Var) || appReportDto.userId != null) {
            hy0Var.A(ll6Var, 3, t47.a, appReportDto.userId);
        }
        if (hy0Var.f(ll6Var) || appReportDto.userEmail != null) {
            hy0Var.A(ll6Var, 4, t47.a, appReportDto.userEmail);
        }
        if (hy0Var.f(ll6Var) || appReportDto.appVersion != null) {
            hy0Var.A(ll6Var, 5, t47.a, appReportDto.appVersion);
        }
        if (hy0Var.f(ll6Var) || appReportDto.androidVersion != null) {
            hy0Var.A(ll6Var, 6, t47.a, appReportDto.androidVersion);
        }
        if (hy0Var.f(ll6Var) || appReportDto.device != null) {
            hy0Var.A(ll6Var, 7, t47.a, appReportDto.device);
        }
    }
    ...
    public /* synthetic */ AppReportDto(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, int i, hl1 hl1Var) {
