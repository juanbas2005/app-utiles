...
public final class ProfileRowDto {
    ...
    public /* synthetic */ ProfileRowDto(int i, String str, String str2, String str3, rl6 rl6Var) {
        if (1 == (i & 1)) {
            this.userId = str;
            if ((i & 2) == 0) {
    ...
    public static final /* synthetic */ void write$Self$data(ProfileRowDto profileRowDto, hy0 hy0Var, ll6 ll6Var) {
        hy0Var.x(ll6Var, 0, profileRowDto.userId);
        if (hy0Var.f(ll6Var) || profileRowDto.invitationCode != null) {
            hy0Var.A(ll6Var, 1, t47.a, profileRowDto.invitationCode);
        }
        if (hy0Var.f(ll6Var) || profileRowDto.registeredWithCode != null) {
            hy0Var.A(ll6Var, 2, t47.a, profileRowDto.registeredWithCode);
        }
    }
    ...
    public /* synthetic */ ProfileRowDto(String str, String str2, String str3, int i, hl1 hl1Var) {
