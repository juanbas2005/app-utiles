...
public final class ForumPostInsertDto {
    ...
    public /* synthetic */ ForumPostInsertDto(int i, String str, String str2, String str3, String str4, String str5, String str6, rl6 rl6) {
        if (31 == (i & 31)) {
            this.userId = str;
    ...
    public static /* synthetic */ ForumPostInsertDto copy$default(ForumPostInsertDto forumPostInsertDto, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
        ...
        String str9 = str4;
        String str10 = str2;
        return forumPostInsertDto.copy(str, str10, str3, str9, str7, str8);
    }

    public static final /* synthetic */ void write$Self$data(ForumPostInsertDto forumPostInsertDto, hy0 hy0, ll6 ll6) {
        hy0.x(ll6, 0, forumPostInsertDto.userId);
        hy0.x(ll6, 1, forumPostInsertDto.authorName);
        hy0.x(ll6, 2, forumPostInsertDto.category);
        hy0.x(ll6, 3, forumPostInsertDto.title);
        hy0.x(ll6, 4, forumPostInsertDto.body);
        if (hy0.f(ll6) || forumPostInsertDto.imagePath != null) {
            hy0.A(ll6, 5, t47.a, forumPostInsertDto.imagePath);
        }
    }
    ...
    public /* synthetic */ ForumPostInsertDto(String str, String str2, String str3, String str4, String str5, String str6, int i, hl1 hl1) {
