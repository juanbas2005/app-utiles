...
public final class ForumPostVoteDto {
    ...
    public /* synthetic */ ForumPostVoteDto(int i, String str, String str2, int i2, rl6 rl6Var) {
        if (7 == (i & 7)) {
            this.postId = str;
            this.userId = str2;
            this.vote = i2;
    ...
    public static final /* synthetic */ void write$Self$data(ForumPostVoteDto forumPostVoteDto, hy0 hy0Var, ll6 ll6Var) {
        hy0Var.x(ll6Var, 0, forumPostVoteDto.postId);
        hy0Var.x(ll6Var, 1, forumPostVoteDto.userId);
        hy0Var.w(2, forumPostVoteDto.vote, ll6Var);
    }
