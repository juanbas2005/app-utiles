...
public final class ForumPostContentDto {
    ...
    public /* synthetic */ ForumPostContentDto(int i, String str, String str2, String str3, String str4, String str5, rl6 rl6Var) {
        if (31 == (i & 31)) {
            this.userId = str;
    ...
    public static /* synthetic */ ForumPostContentDto copy$default(ForumPostContentDto forumPostContentDto, String str, String str2, String str3, String str4, String str5, int i, Object obj) {
        ...
        String str6 = str5;
        String str7 = str3;
        return forumPostContentDto.copy(str, str2, str7, str4, str6);
    }

    public static final /* synthetic */ void write$Self$data(ForumPostContentDto forumPostContentDto, hy0 hy0Var, ll6 ll6Var) {
        hy0Var.x(ll6Var, 0, forumPostContentDto.userId);
        hy0Var.x(ll6Var, 1, forumPostContentDto.authorName);
        hy0Var.x(ll6Var, 2, forumPostContentDto.category);
        hy0Var.x(ll6Var, 3, forumPostContentDto.title);
        hy0Var.x(ll6Var, 4, forumPostContentDto.body);
    }
