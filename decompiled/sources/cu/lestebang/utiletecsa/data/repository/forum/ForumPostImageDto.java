...
public final class ForumPostImageDto {
    ...
    public /* synthetic */ ForumPostImageDto(int i, String str, rl6 rl6Var) {
        if ((i & 1) == 0) {
            this.image = null;
        } else {
            this.image = str;
    ...
    public static final /* synthetic */ void write$Self$data(ForumPostImageDto forumPostImageDto, hy0 hy0Var, ll6 ll6Var) {
        if (hy0Var.f(ll6Var) || forumPostImageDto.image != null) {
            hy0Var.A(ll6Var, 0, t47.a, forumPostImageDto.image);
        }
    }
    ...
    public /* synthetic */ ForumPostImageDto(String str, int i, hl1 hl1Var) {
        this((i & 1) != 0 ? null : str);
    }
