...
public final class SpotInsertDto {
    ...
    public /* synthetic */ SpotInsertDto(int i, String str, String str2, String str3, String str4, String str5, String str6, Double d, Double d2, String str7, String str8, rl6 rl6) {
        if (527 == (i & 527)) {
            this.nick = str;
    ...
    public static /* synthetic */ SpotInsertDto copy$default(SpotInsertDto spotInsertDto, String str, String str2, String str3, String str4, String str5, String str6, Double d, Double d2, String str7, String str8, int i, Object obj) {
        ...
        String str13 = str4;
        String str14 = str2;
        return spotInsertDto.copy(str, str14, str3, str13, str11, str12, d3, d4, str9, str10);
    }

    public static final /* synthetic */ void write$Self$data(SpotInsertDto spotInsertDto, hy0 hy0, ll6 ll6) {
        hy0.x(ll6, 0, spotInsertDto.nick);
        hy0.x(ll6, 1, spotInsertDto.connectionType);
        hy0.x(ll6, 2, spotInsertDto.quality);
        hy0.x(ll6, 3, spotInsertDto.address);
        if (hy0.f(ll6) || spotInsertDto.province != null) {
            hy0.A(ll6, 4, t47.a, spotInsertDto.province);
        }
        if (hy0.f(ll6) || spotInsertDto.note != null) {
            hy0.A(ll6, 5, t47.a, spotInsertDto.note);
        }
        if (hy0.f(ll6) || spotInsertDto.latitude != null) {
            hy0.A(ll6, 6, ix1.a, spotInsertDto.latitude);
        }
        if (hy0.f(ll6) || spotInsertDto.longitude != null) {
            hy0.A(ll6, 7, ix1.a, spotInsertDto.longitude);
        }
        if (hy0.f(ll6) || spotInsertDto.userId != null) {
            hy0.A(ll6, 8, t47.a, spotInsertDto.userId);
        }
        hy0.x(ll6, 9, spotInsertDto.deviceId);
    }
    ...
    public int hashCode() {
        ...
        return this.deviceId.hashCode() + ((i9 + i5) * 31);
    }
    ...
    public /* synthetic */ SpotInsertDto(String str, String str2, String str3, String str4, String str5, String str6, Double d, Double d2, String str7, String str8, int i, hl1 hl1) {
