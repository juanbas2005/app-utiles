...
public final class ContactDetail {
    ...
    public /* synthetic */ ContactDetail(int i, String str, String str2, String str3, rl6 rl6) {
        if (3 == (i & 3)) {
            this.name = str;
            this.phone = str2;
            if ((i & 4) == 0) {
    ...
    public static final /* synthetic */ void write$Self$registro(ContactDetail contactDetail, hy0 hy0, ll6 ll6) {
        hy0.x(ll6, 0, contactDetail.name);
        hy0.x(ll6, 1, contactDetail.phone);
        if (hy0.f(ll6) || !sg3.e(contactDetail.tab, "calls")) {
            hy0.x(ll6, 2, contactDetail.tab);
        }
    }
    ...
    public /* synthetic */ ContactDetail(String str, String str2, String str3, int i, hl1 hl1) {
