...
public final class Dialer {
    ...
    public /* synthetic */ Dialer(int i, String str, String str2, rl6 rl6Var) {
        if (3 == (i & 3)) {
            this.prefix = str;
            this.title = str2;
            return;
    ...
    public static final /* synthetic */ void write$Self$home(Dialer dialer, hy0 hy0Var, ll6 ll6Var) {
        hy0Var.x(ll6Var, 0, dialer.prefix);
        hy0Var.x(ll6Var, 1, dialer.title);
    }
