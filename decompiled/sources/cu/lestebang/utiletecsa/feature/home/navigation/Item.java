...
public final class Item {
    ...
    public /* synthetic */ Item(int i, String str, rl6 rl6) {
        if (1 == (i & 1)) {
            this.itemId = str;
        } else {
