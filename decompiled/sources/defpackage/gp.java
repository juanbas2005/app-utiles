...
public class gp extends RadioButton implements aj7 {
    public final go w;
    public final ao x;
    public final cq y;
    public bp z;
    ...
    public gp(Context context, AttributeSet attributeSet) {
        ...
        this.w = goVar;
        goVar.c(attributeSet, R.attr.radioButtonStyle);
        ao aoVar = new ao(this);
        this.x = aoVar;
        aoVar.d(attributeSet, R.attr.radioButtonStyle);
        cq cqVar = new cq(this);
        this.y = cqVar;
        cqVar.f(attributeSet, R.attr.radioButtonStyle);
