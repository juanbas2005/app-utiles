...
public final class tm5 {
    ...
    public tm5(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
        if (Build.VERSION.SDK_INT >= 29) {
            tj5.e(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
        }
        this.a = textPaint;
    ...
    public final boolean equals(Object obj) {
        ...
        tm5 tm5 = (tm5) obj;
        int i = tm5.c;
        TextPaint textPaint = tm5.a;
        if (this.c != i || this.d != tm5.d) {
            return false;
        }
    ...
    public tm5(PrecomputedText.Params params) {
