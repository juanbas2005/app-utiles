...
public final class ja6 implements AlgorithmIdentifier {
    public static final ja6 a = new Object();

    /* renamed from: getAlgorithm-STa95mE  reason: not valid java name */
    public final String m47getAlgorithmSTa95mE() {
        ObjectIdentifier.Companion.getClass();
        return ObjectIdentifier.m20constructorimpl("1.2.840.113549.1.1.1");
    }
