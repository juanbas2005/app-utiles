...
public final class be3 extends HttpsURLConnection {
    public final ce3 a;
    public final HttpsURLConnection b;

    public be3(HttpsURLConnection httpsURLConnection, ui7 ui7, sy4 sy4) {
        super(httpsURLConnection.getURL());
        this.b = httpsURLConnection;
        this.a = new ce3(httpsURLConnection, ui7, sy4);
    }
