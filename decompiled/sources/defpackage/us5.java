...
public final class us5 extends zu2 {
    public static final us5 A;
    public static final fp3 B = new fp3(19);
    public final bg0 w;
    public List x;
    public byte y;
    public int z;
    ...
    static {
        us5 us5 = new us5();
        A = us5;
        us5.x = Collections.EMPTY_LIST;
    }

    public us5(ts0 ts0, y92 y92) {
        this.y = -1;
        this.z = -1;
