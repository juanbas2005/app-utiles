...
public final class c5 {
    ...
    public c5(AccessibilityNodeInfo accessibilityNodeInfo) {
    ...
    public final void b(w4 w4Var) {
        this.a.addAction((AccessibilityNodeInfo.AccessibilityAction) w4Var.a);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.c == c5Var.c && this.b == c5Var.b) {
            return true;
        }
        return false;
    }
    ...
    public final CharSequence g() {
        ...
        for (int i = 0; i < c2.size(); i++) {
            spannableString.setSpan(new i4(((Integer) c5.get(i)).intValue(), this, accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) c2.get(i)).intValue(), ((Integer) c3.get(i)).intValue(), ((Integer) c4.get(i)).intValue());
        }
    ...
    public final void j(r16 r16) {
        this.a.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) null);
    }
    ...
    public final String toString() {
        ...
        if (i3 >= 34) {
            l4.e(accessibilityNodeInfo, rect);
        } else {
        ...
        if (i3 >= 30) {
            charSequence = x4.d(accessibilityNodeInfo);
        } else {
        ...
        if (i3 >= 36) {
            charSequence2 = z4.c(accessibilityNodeInfo);
        } else {
        ...
        sb.append("; uniqueId: ");
        if (i3 >= 33) {
            str = y4.e(accessibilityNodeInfo);
        } else {
        ...
        if (i3 >= 34) {
            charSequence4 = l4.f(accessibilityNodeInfo);
        } else {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            arrayList.add(new w4(actionList.get(i4), 0, (CharSequence) null, (t5) null, (Class) null));
        }
