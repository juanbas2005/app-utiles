...
public final class SpotVoteDto {
    ...
    public /* synthetic */ SpotVoteDto(int i, String str, String str2, int i2, String str3, rl6 rl6) {
        if (7 == (i & 7)) {
            this.spotId = str;
            this.deviceId = str2;
            this.vote = i2;
    ...
    public static final /* synthetic */ void write$Self$data(SpotVoteDto spotVoteDto, hy0 hy0, ll6 ll6) {
        hy0.x(ll6, 0, spotVoteDto.spotId);
        hy0.x(ll6, 1, spotVoteDto.deviceId);
        hy0.w(2, spotVoteDto.vote, ll6);
        if (hy0.f(ll6) || spotVoteDto.userId != null) {
            hy0.A(ll6, 3, t47.a, spotVoteDto.userId);
        }
    }
    ...
    public /* synthetic */ SpotVoteDto(String str, String str2, int i, String str3, int i2, hl1 hl1) {
