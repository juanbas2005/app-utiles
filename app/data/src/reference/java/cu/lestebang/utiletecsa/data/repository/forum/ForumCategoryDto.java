...
public final class ForumCategoryDto {
    ...
    public /* synthetic */ ForumCategoryDto(int i, String str, String str2, rl6 rl6) {
        if (3 == (i & 3)) {
            this.key = str;
            this.label = str2;
            return;
    ...
    public static final /* synthetic */ void write$Self$data(ForumCategoryDto forumCategoryDto, hy0 hy0, ll6 ll6) {
        hy0.x(ll6, 0, forumCategoryDto.key);
        hy0.x(ll6, 1, forumCategoryDto.label);
    }
