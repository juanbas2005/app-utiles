...
public final class LicenseRequestDto {
    ...
    public /* synthetic */ LicenseRequestDto(int i, String str, String str2, String str3, String str4, String str5, rl6 rl6) {
        if (7 == (i & 7)) {
            this.userId = str;
    ...
    public static /* synthetic */ LicenseRequestDto copy$default(LicenseRequestDto licenseRequestDto, String str, String str2, String str3, String str4, String str5, int i, Object obj) {
        ...
        String str6 = str4;
        String str7 = str5;
        return licenseRequestDto.copy(str, str2, str3, str6, str7);
    }

    public static final /* synthetic */ void write$Self$data(LicenseRequestDto licenseRequestDto, hy0 hy0, ll6 ll6) {
        hy0.x(ll6, 0, licenseRequestDto.userId);
        hy0.x(ll6, 1, licenseRequestDto.transferId);
        hy0.x(ll6, 2, licenseRequestDto.status);
        if (hy0.f(ll6) || licenseRequestDto.activatedAt != null) {
            hy0.A(ll6, 3, t47.a, licenseRequestDto.activatedAt);
        }
        if (hy0.f(ll6) || licenseRequestDto.imagePath != null) {
            hy0.A(ll6, 4, t47.a, licenseRequestDto.imagePath);
        }
    }
    ...
    public /* synthetic */ LicenseRequestDto(String str, String str2, String str3, String str4, String str5, int i, hl1 hl1) {
