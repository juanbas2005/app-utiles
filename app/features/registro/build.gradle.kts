// :features:registro — DESACTIVADO (no incluido en settings.gradle.kts)
//
...
// Al habilitarlo, incluir en settings.gradle.kts: include(":features:registro")
plugins {
    alias(libs.plugins.android.library)
}

android {
    namespace = "cu.lestebang.utiletecsa.feature.registro"
    compileSdk = 37
    defaultConfig {
        minSdk = 24
