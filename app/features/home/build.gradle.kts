// :features:home — DESACTIVADO (no incluido en settings.gradle.kts)
//
...
// Al habilitarlo, incluir en settings.gradle.kts: include(":features:home")
plugins {
    alias(libs.plugins.android.library)
}

android {
    namespace = "cu.lestebang.utiletecsa.feature.home"
    compileSdk = 37
    defaultConfig {
        minSdk = 24
