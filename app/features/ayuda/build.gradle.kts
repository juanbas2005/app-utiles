// :features:ayuda — DESACTIVADO (no incluido en settings.gradle.kts)
//
...
// Al habilitarlo, incluir en settings.gradle.kts: include(":features:ayuda")
plugins {
    alias(libs.plugins.android.library)
}

android {
    namespace = "cu.lestebang.utiletecsa.feature.ayuda"
    compileSdk = 37
    defaultConfig {
        minSdk = 24
