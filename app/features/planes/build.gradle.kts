// :features:planes — DESACTIVADO (no incluido en settings.gradle.kts)
//
...
// Al habilitarlo, incluir en settings.gradle.kts: include(":features:planes")
plugins {
    alias(libs.plugins.android.library)
}

android {
    namespace = "cu.lestebang.utiletecsa.feature.planes"
    compileSdk = 37
    defaultConfig {
        minSdk = 24
