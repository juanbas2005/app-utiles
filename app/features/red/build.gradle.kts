// :features:red — DESACTIVADO (no incluido en settings.gradle.kts)
//
...
// Al habilitarlo, incluir en settings.gradle.kts: include(":features:red")
plugins {
    alias(libs.plugins.android.library)
}

android {
    namespace = "cu.lestebang.utiletecsa.feature.red"
    compileSdk = 37
    defaultConfig {
        minSdk = 24
