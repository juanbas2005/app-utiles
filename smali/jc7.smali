...
.method public final a()Landroid/graphics/Canvas;
    ...
    .line 1
    iget-object p0, p0, Ljc7;->a:Landroid/graphics/Canvas;
    ...
    .line 7
    .line 8
    invoke-static {p0}, Lzb3;->c(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 1
    invoke-virtual {p0}, Ljc7;->a()Landroid/graphics/Canvas;
    ...
    .line 5
    invoke-static {p0, p1}, Lrk0;->y(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    .line 13
    invoke-static {p0, p1, p2, p3, p4}, Lrk0;->x(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    .line 15
    invoke-static {p0, p1, p2, p3, p4}, Lz10;->y(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    .line 11
    invoke-static {p0, p1}, Lz10;->z(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    .line 5
    invoke-static {p0, p1}, Lz10;->A(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final disableZ()V
    ...
    .line 5
    invoke-static {p0}, Lnd;->j(Landroid/graphics/Canvas;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    .line 13
    invoke-static {p0, p1, p2}, Lnd;->k(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    .line 10
    invoke-static {p0, p1, p2}, Lnd;->l(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    .line 15
    invoke-static {p0, p1, p2, p3}, Lnd;->m(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Lnd;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static/range {p0 .. p5}, Lnd;->o(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Lse;->t(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static {p0, p1, p2, p3}, Lse;->r(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static {p0, p1, p2, p3}, Lse;->s(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 5
    invoke-static {p0, p1}, Lnd;->p(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 12
    invoke-static/range {p0 .. p9}, Lnd;->q(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    .line 5
    invoke-static {p0}, Lnd;->x(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    .line 17
    invoke-static {p0, p1, p2, p3, p4}, Lt4;->q(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    .line 14
    invoke-static {p0, p1}, Lt4;->r(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    .line 11
    invoke-static {p0, p1}, Lt4;->s(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
